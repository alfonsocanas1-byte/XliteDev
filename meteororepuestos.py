...
def main():
    ...
    usuario = "alfonsocanas1-byte"  # Tu usuario actualizado
    repo = "XliteDev"               # Tu repositorio
    branch = "main"                 # Tu rama principal
    
    # Esta URL apunta directamente al archivo crudo (raw) para que se vea la imagen
    ...
    for i, prod in enumerate(productos):
        with cols[i]:
            # Se usa la URL Raw de GitHub para evitar el error de carga
