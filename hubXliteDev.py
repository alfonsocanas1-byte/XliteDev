...
def cargar_datos():
    estructura_objetivo = {
        "config": {"version": "2.2", "branch": "Xlite"},
        "modulos": {
...
if st.session_state.submodulo_activo:
    # Aviso de logística específico para Agro-pro si se entra a uno de sus submódulos
    ...
    elif st.session_state.submodulo_activo in ["Meteoro-combustible", "Meteoro-GPS", "Alimentos y productos naturales", "Confecciones"]:
    ...
    if "0." in menu:
        ...
        st.header("🚜 Agro-pro")
        # Aviso de logística en la parte superior del lobby del módulo 2
