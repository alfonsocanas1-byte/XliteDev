...
def cargar_datos():
    # Se actualiza el nombre del primer punto del hub según lo solicitado
    estructura_objetivo = {
...
# Sidebar - Se actualiza el texto del primer punto
...
elif st.session_state.submodulo_activo == "Meteoro-ingeniería":
