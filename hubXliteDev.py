...
# 1. Configuración de la página - DEBE IR PRIMERO Y SOLO AQUÍ
st.set_page_config(
...
def cargar_datos():
    estructura_objetivo = {
        "config": {"version": "2.6", "branch": "Xlite"},
        "modulos": {
...
opciones_menu = ["0. Registro Inicial Xlite", "1. Ingeniería y Tecnología.", "2. Agro-pro", "3. ACOarte"]
...
if st.session_state.submodulo_activo:
    ...
    if "0." in menu:
        ...
        with col_foto:
            # USANDO LA FOTO QUE SUBISTE
            st.image(f"{BASE_URL_GH}alfonsocanas1.jpg", width=200, caption="Alfonso Cañas")
        with col_info:
...
st.sidebar.markdown("---")
st.sidebar.caption(f"Versión: 2.6 | Universo")