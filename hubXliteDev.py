...
def cargar_datos():
    # Estructura maestra actualizada
    estructura_objetivo = {
        "config": {"version": "1.1", "branch": "Xlite"},
        "modulos": {
    ...
    # Si no existe o hay error de lectura, retornamos la estructura objetivo directamente
    # Esto evita el IndexError en Streamlit Cloud al ignorar archivos JSON corruptos o viejos
...
# Sidebar con el nuevo orden solicitado
...
# Función genérica para renderizar botones y evitar IndexError
...
if "1." in menu:
    ...
    renderizar_submodulos("Salud_Emocional", "Médico y Apoyo Emocional", "🩺")
    ...
    st.info(f"Módulo {menu} seleccionado. Esperando configuración.")
