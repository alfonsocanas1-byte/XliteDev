...
def renderizar_submodulos(nombre_modulo, titulo, icono):
    ...
    if submodulos:
        # Usamos botones normales para cambiar el estado de la aplicación
...
# Botón para volver al menú principal en caso de estar en un submódulo
...
# Si hay un submódulo activo, lo ejecutamos
