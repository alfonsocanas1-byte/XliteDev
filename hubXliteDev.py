...
def cargar_datos():
    ...
    try:
        ...
        # Sincronizar estructura si hay cambios
...
# Función genérica para renderizar botones de submódulos
...
# Inicializar estado del submódulo activo
if 'submodulo_activo' not in st.session_state:
    st.session_state.submodulo_activo = None

# Botón para volver al menú principal desde un submódulo
...
if st.session_state.submodulo_activo == "Restaurante gourmet":
    ...
    if "0." in menu:
        ...
        st.write("¡Bienvenido! Regístrate para acceder a todos los beneficios de la plataforma.")
        ...
        st.success("Haz clic en el botón de abajo para iniciar tu registro vía WhatsApp.")
        ...
        st.info(f"Módulo {menu} seleccionado. Contenido en desarrollo.")
